...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //region Building AlertDialog
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        LinearLayout linearLayout= new LinearLayout(this);
        linearLayout.setOrientation(LinearLayout.VERTICAL);
        final EditText userInput = new EditText(this);
        userInput.requestFocus();
        userInput.setHint(getResources().getString(R.string.name)); //enter name here
        ...
        alert.setTitle(getResources().getString(R.string.title))
                .setMessage(getResources().getString(R.string.rules)).setView(linearLayout)
            ...
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                finishAndRemoveTask(); //if user clicks cancel app closes
            }
        }).show();
    ...
    public void onRock(View view) {
        ...
        score.setText(String.format("%%s", getResources().getString(R.string.msg,humScore,compScore)));
    }
    ...
    public void onGameEnd(View view) {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run(){
                userDatabase.getUserDAO().insertScore(user);
                finish();
            }
        });
